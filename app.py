...
# ----------------------------------------------------------------------------
    ...
    st.plotly_chart(style_fig(fig2, 400), width='stretch')
    ...
    fig3 = go.Figure()
    fig3.add_trace(go.Bar(x=headline["Year"], y=headline["Nominal GDP % Chg"],
                           name="Nominal GDP % Chg", marker_color=COPPER))
    fig3.add_trace(go.Bar(x=headline["Year"], y=headline["Real GDP % Chg"],
                           name="Real GDP % Chg", marker_color=INK))
    fig3.update_layout(barmode="group", yaxis_title="% Change")
    st.plotly_chart(style_fig(fig3, 360), width='stretch')
...
# ----------------------------------------------------------------------------
    ...
    fig = go.Figure()
    fig.add_trace(go.Scatter(x=rdf["Year"], y=rdf["Unemployment Rate (%)"],
...
# ----------------------------------------------------------------------------
    ...
    fig = go.Figure()
    fig.add_trace(go.Bar(x=df["Year"], y=df["Annual Inflation Rate (%)"],
                          name="Annual Inflation Rate", marker_color=BRICK, opacity=0.85))
    fig.add_trace(go.Scatter(x=df["Year"], y=df["CPI Value (%)"],
                              name="CPI Value", mode="lines+markers",
...
# ----------------------------------------------------------------------------
    ...
    fig = go.Figure(go.Scatter(x=df["Year"], y=df["Policy Rate (%)"], mode="lines+markers",
